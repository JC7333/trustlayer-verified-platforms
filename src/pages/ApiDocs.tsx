...
const endpoints = [
  ...
  },
  {
    ...
    path: "/v1/profiles/:id",
    description:
      "Obtenir un profil prestataire avec son statut de vérification",
  },
  {
    method: "POST",
      ...
      <main className="pt-24">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Intégrez TrustLayer dans votre plateforme avec notre API
                RESTful. Contrôle total sur les workflows de vérification, la
                gestion des documents et l'intégration des badges.
              </p>
            ...
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Générez et rotez vos clés par environnement avec des scopes de
                  permissions.
                </p>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Notifications temps réel pour les changements de statut et
                  expirations.
                </p>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Limites généreuses avec capacité de burst. Quotas dédiés pour
                  Enterprise.
                </p>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  HTTPS obligatoire, signatures webhook, et chiffrement bout en
                  bout.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-muted-foreground mb-8">
                Abonnez-vous à ces événements pour recevoir des notifications
                temps réel sur le cycle de vie des vérifications.
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                Widget Badge Intégrable
              </h2>
              <p className="text-muted-foreground mb-8">
                Affichez le statut de vérification sur votre plateforme avec
                notre widget léger et personnalisable.
              </p>
        ...
        <section className="py-16 gradient-hero">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-primary-foreground/70 mb-8 max-w-xl mx-auto">
              Créez votre compte sandbox gratuit et commencez à explorer notre
